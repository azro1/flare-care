  ...
  return (
    <div className="w-full sm:px-4 md:px-6 min-w-0">
      ...
      <div className="card mb-5 sm:mb-6">
        <h2 className="text-xl font-semibold font-source text-primary mb-4 sm:mb-6 break-words">What is Inflammatory Bowel Disease (IBD)?</h2>
      ...
      <div className="card backdrop-blur-sm mb-5 sm:mb-6">
        <h2 className="text-xl font-semibold font-source text-primary mb-4 sm:mb-6 break-words">Common Symptoms</h2>
      ...
      {/* Triggers Section */}
      <div className="card mb-5 sm:mb-6">
        <h2 className="text-xl font-semibold font-source text-primary mb-4 sm:mb-6 break-words">Common Triggers</h2>
      ...
      <div className="card mb-5 sm:mb-6">
        <h2 className="text-xl font-semibold font-source text-primary mb-4 sm:mb-6">When to Seek Medical Help</h2>
        <div>
      ...
      <div className="card backdrop-blur-sm mb-5 sm:mb-6">
        <h2 className="text-xl font-semibold font-source text-primary mb-4 sm:mb-6">How FlareCare Can Help</h2>
        <div className="card-inner p-4 sm:p-6">
      ...
      {/* Resources Section */}
      <div className="card backdrop-blur-sm mb-5 sm:mb-6">
        <h2 className="text-xl font-semibold font-source text-primary mb-4 sm:mb-6">Helpful Resources</h2>
        <div className="grid gap-3 md:gap-6 md:grid-cols-2">
