    ...
    <div className="w-full sm:px-4 md:px-6 min-w-0">
            ...
            <div className="card">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-sm text-secondary leading-normal">Keep a food diary to track triggers</p>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 min-w-[2rem] rounded-lg flex items-center justify-center card-inner">
                    <CupSoda className="w-4 h-4 text-sky-600 dark:[color:var(--text-goal-icon-hydration)]" />
                  </div>
                  <p className="text-sm text-secondary leading-normal">Stay hydrated throughout the day</p>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 min-w-[2rem] rounded-lg flex items-center justify-center card-inner">
                    <Cookie className="w-4 h-4 text-amber-600 dark:[color:var(--text-icon-more-foods)]" />
                  </div>
                  <p className="text-sm text-secondary leading-normal">Eat smaller, frequent meals</p>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 min-w-[2rem] rounded-lg flex items-center justify-center card-inner">
                    <Stethoscope className="w-4 h-4 text-indigo-400 dark:[color:var(--text-icon-more-meds)]" />
                  </div>
                  <p className="text-sm text-secondary leading-normal">Follow your healthcare team's advice</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <div className="border-l-4" style={{ borderColor: '#5F9EA0', opacity: 0.85 }}>
                  <div className="pl-3">
                    ...
                    <p className="text-sm text-secondary leading-normal">Non-emergency medical advice</p>
                  <p className="text-sm font-medium leading-normal" style={{ color: '#5F9EA0' }}>Call 111</p>
                  </div>
                </div>
              <div className="border-l-4" style={{ borderColor: '#5F9EA0', opacity: 0.85 }}>
                  <div className="pl-3">
                    <h4 className="font-medium text-primary">Crohn's & Colitis UK</h4>
                    <p className="text-sm text-secondary leading-normal">Support helpline</p>
                  <p className="text-sm font-medium leading-normal" style={{ color: '#5F9EA0' }}>0300 222 9099</p>
                  </div>
                </div>
              <div className="border-l-4" style={{ borderColor: '#5F9EA0', opacity: 0.85 }}>
                  <div className="pl-3">
                    <h4 className="font-medium text-primary">Emergency Services</h4>
                    <p className="text-sm text-secondary leading-normal">For life-threatening situations</p>
                  <p className="text-sm font-medium leading-normal" style={{ color: '#5F9EA0' }}>Call 999</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="card">
              ...
              <div className="space-y-3">
                <p
                  ...
                  className={`text-sm text-secondary leading-normal transition-opacity duration-500 ${
      ...
      <div className="card mb-5 sm:mb-6">
        ...
        <div className="prose prose-gray max-w-none">
          <p className="text-sm text-secondary mb-6 font-sans break-words leading-normal">
          ...
          <div className="grid gap-4 sm:gap-6 md:grid-cols-2">
            <div className="card-inner p-4 sm:p-6">
              ...
              <ul className="text-secondary space-y-2 text-sm font-sans break-words">
                <li className="leading-normal"><span className="text-[#5F9EA0] mr-2">•</span>Can affect any part of the digestive tract</li>
                <li className="leading-normal"><span className="text-[#5F9EA0] mr-2">•</span>Inflammation can be patchy with healthy areas in between</li>
                <li className="leading-normal"><span className="text-[#5F9EA0] mr-2">•</span>Can affect the full thickness of the bowel wall</li>
                <li className="leading-normal"><span className="text-[#5F9EA0] mr-2">•</span>May cause complications like fistulas and strictures</li>
              </ul>
            </div>
            ...
            <div className="card-inner p-4 sm:p-6">
              ...
              <ul className="text-secondary space-y-2 text-sm font-sans break-words">
                <li className="leading-normal"><span className="text-[#5F9EA0] mr-2">•</span>Affects only the colon and rectum</li>
                <li className="leading-normal"><span className="text-[#5F9EA0] mr-2">•</span>Inflammation is continuous, starting from the rectum</li>
                <li className="leading-normal"><span className="text-[#5F9EA0] mr-2">•</span>Usually affects only the inner lining of the colon</li>
                <li className="leading-normal"><span className="text-[#5F9EA0] mr-2">•</span>May increase risk of colon cancer over time</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div className="card backdrop-blur-sm mb-5 sm:mb-6">
        ...
        <div className="grid gap-2 md:gap-6 md:grid-cols-2">
          <ul className="space-y-2 text-sm text-secondary font-sans break-words">
            <li className="flex items-start leading-normal">
      ...
      <div className="card mb-5 sm:mb-6">
        ...
        <div className="grid gap-4 sm:gap-6 md:grid-cols-3">
          <div className="card-inner p-4 sm:p-6 text-center">
            ...
            <p className="text-sm text-secondary font-sans break-words leading-normal">
        ...
        <div className="grid gap-3 md:gap-6 md:grid-cols-2">
          <ul className="space-y-3 font-sans">
            <li>
              ...
              <p className="text-sm text-secondary font-sans leading-normal">Leading UK charity providing support and information</p>
            </li>
            <li>
              <a 
              ...
              <p className="text-sm text-secondary font-sans leading-normal">US-based organization with comprehensive resources</p>
            </li>
          </ul>
          ...
          <ul className="space-y-3 font-sans">
            <li>
              ...
              <p className="text-sm text-secondary font-sans leading-normal">Official NHS guidance on IBD</p>
            </li>
            <li>
              <a 
              ...
              <p className="text-sm text-secondary font-sans leading-normal">Comprehensive medical information</p>
            </li>
          </ul>
        </div>
      </div>
      ...
      {/* Call to Action */}
        <div className="mt-5 sm:mt-6 lg:mt-0">
          ...
          <p className="text-sm text-secondary font-sans mb-4 sm:mb-6 leading-normal">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center sm:items-stretch space-y-3 sm:space-y-0 sm:space-x-4">
            {isAuthenticated ? (
              <Link href="/medications/track" className="bg-[#5F9EA0] hover:bg-button-cadet-hover text-white font-semibold py-3 px-6 rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-lg active:scale-95 font-sans w-auto">
                Log meds
              </Link>
            ) : (
              <>
                <Link href="/auth" className="bg-[#5F9EA0] hover:bg-button-cadet-hover text-white font-semibold py-3 px-6 rounded-xl transition-all duration-300 hover:shadow-lg font-sans">
                  Start Tracking
                </Link>
              </>
            )}
