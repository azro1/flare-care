    ...
    <div className="w-full sm:px-4 md:px-6 min-w-0">
            ...
            <div className="card">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-sm sm:text-base text-secondary leading-relaxed">Keep a food diary to track triggers</p>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 min-w-[2rem] rounded-lg flex items-center justify-center card-inner">
                    <CupSoda className="w-4 h-4 text-sky-600 dark:text-white" />
                  </div>
                  <p className="text-sm sm:text-base text-secondary leading-relaxed">Stay hydrated throughout the day</p>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 min-w-[2rem] rounded-lg flex items-center justify-center card-inner">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-sm sm:text-base text-secondary leading-relaxed">Follow your healthcare team's advice</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <div className="border-l-4" style={{ borderColor: '#5F9EA0', opacity: 0.85 }}>
                  <div className="pl-3">
                    ...
                    <p className="text-sm sm:text-base text-secondary leading-relaxed">Non-emergency medical advice</p>
              ...
              <div className="border-l-4" style={{ borderColor: '#5F9EA0', opacity: 0.85 }}>
                  <div className="pl-3">
                    ...
                    <p className="text-sm sm:text-base text-secondary leading-relaxed">Support helpline</p>
              ...
              <div className="border-l-4" style={{ borderColor: '#5F9EA0', opacity: 0.85 }}>
                  <div className="pl-3">
                    ...
                    <p className="text-sm sm:text-base text-secondary leading-relaxed">For life-threatening situations</p>
      ...
      <div className="card mb-5 sm:mb-6">
        ...
        <div className="prose prose-gray max-w-none">
          <p className="text-sm sm:text-base text-secondary mb-6 font-roboto break-words leading-relaxed">
      ...
      <div className="card mb-5 sm:mb-6">
        ...
        <div className="grid gap-4 sm:gap-6 md:grid-cols-3">
          <div className="card-inner p-4 sm:p-6 text-center">
            ...
            <p className="text-sm sm:text-base text-secondary font-roboto break-words leading-relaxed">
        ...
        <div className="grid gap-3 md:gap-6 md:grid-cols-2">
          <ul className="space-y-3 font-roboto">
            <li>
              ...
              <p className="text-sm sm:text-base text-secondary font-roboto leading-relaxed">Leading UK charity providing support and information</p>
            </li>
            <li>
              <a 
              ...
              <p className="text-sm sm:text-base text-secondary font-roboto leading-relaxed">US-based organization with comprehensive resources</p>
            </li>
          </ul>
          ...
          <ul className="space-y-3 font-roboto">
            <li>
              ...
              <p className="text-sm sm:text-base text-secondary font-roboto leading-relaxed">Official NHS guidance on IBD</p>
            </li>
            <li>
              <a 
              ...
              <p className="text-sm sm:text-base text-secondary font-roboto leading-relaxed">Comprehensive medical information</p>
            </li>
          </ul>
        </div>
      </div>
