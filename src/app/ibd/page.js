  ...
  return (
    <div className="w-full sm:px-4 md:px-6 min-w-0">
      <div className="flex flex-col lg:flex-row lg:gap-6 lg:justify-center">
        ...
        <div className="lg:w-72 lg:flex-shrink-0 order-2 lg:order-1 lg:mb-6">
          <div className="sticky top-6 space-y-5 sm:space-y-6">
            ...
            {/* Daily Tips */}
            <div className="card">
              <h3 className="text-xl font-bold font-source text-primary mb-4">Daily Tips</h3>
            ...
            <div className="card backdrop-blur-sm">
              <h3 className="text-xl font-bold font-source text-primary mb-4">Emergency Contacts</h3>
            <div className="space-y-3">
            ...
            {/* Quick Facts */}
            <div className="card">
              <h3 className="text-xl font-bold font-source text-primary mb-4">Quick Facts</h3>
              <div className="space-y-3">
                <p
                  key={QUICK_FACTS[currentFactIndex]}
                  className={`text-sm text-secondary leading-relaxed transition-opacity duration-500 ${
      ...
      <div className="card mb-5 sm:mb-6">
        <h2 className="text-xl font-bold font-source text-primary mb-4 sm:mb-6 break-words">What is Inflammatory Bowel Disease (IBD)?</h2>
      ...
      <div className="card backdrop-blur-sm mb-5 sm:mb-6">
        <h2 className="text-xl font-bold font-source text-primary mb-4 sm:mb-6 break-words">Common Symptoms</h2>
      ...
      {/* Triggers Section */}
      <div className="card mb-5 sm:mb-6">
        <h2 className="text-xl font-bold font-source text-primary mb-4 sm:mb-6 break-words">Common Triggers</h2>
      ...
      <div className="card mb-5 sm:mb-6">
        <h2 className="text-xl font-bold font-source text-primary mb-4 sm:mb-6">When to Seek Medical Help</h2>
        <div>
      ...
      <div className="card backdrop-blur-sm mb-5 sm:mb-6">
        <h2 className="text-xl font-bold font-source text-primary mb-4 sm:mb-6">How FlareCare Can Help</h2>
        <div className="card-inner p-4 sm:p-6">
      ...
      {/* Resources Section */}
      <div className="card backdrop-blur-sm mb-5 sm:mb-6">
        <h2 className="text-xl font-bold font-source text-primary mb-4 sm:mb-6">Helpful Resources</h2>
        <div className="grid gap-3 md:gap-6 md:grid-cols-2">
      ...
      {/* Call to Action */}
        <div className="mt-5 sm:mt-6 lg:mt-0">
          ...
          <h2 className="text-xl font-bold font-source text-primary mb-4">Track Your Medications</h2>
