      ...
      <div className="mb-4">
        ...
        {currentStep === 0 && (
          <div className="flex flex-col items-center justify-center text-center pt-20 sm:pt-0">
            ...
            <p className="text-base sm:text-lg font-roboto text-muted mb-8 max-w-md">Track your daily symptoms to identify patterns and triggers</p>
        ...
        {currentStep === 17 && (
          <div className="space-y-8">
            ...
            <div className="card border" style={{borderColor: 'var(--border-card)'}}>
              <h3 className="text-xl font-semibold text-cadet-blue mb-4 pb-4 border-b" style={{borderColor: 'var(--border-primary)'}}>Basic Information</h3>
            ...
            {/* Bathroom Frequency */}
            <div className="card border" style={{borderColor: 'var(--border-card)'}}>
              <h3 className="text-xl font-semibold text-cadet-blue mb-4 pb-4 border-b" style={{borderColor: 'var(--border-primary)'}}>Bathroom Frequency</h3>
              <div className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
            ...
            {isFirstTimeUser && (formData.smoking !== undefined || formData.alcohol !== undefined) && (
              <div className="card border" style={{borderColor: 'var(--border-card)'}}>
                <h3 className="text-xl font-semibold text-cadet-blue mb-4 pb-4 border-b" style={{borderColor: 'var(--border-primary)'}}>Lifestyle</h3>
                <div className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
            ...
            {(() => {
              ...
              return (
                <div className="card border" style={{borderColor: 'var(--border-card)'}}>
                  <h3 className="text-xl font-semibold text-cadet-blue mb-4 pb-4 border-b" style={{borderColor: 'var(--border-primary)'}}>Meals</h3>
