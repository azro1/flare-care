      ...
      <div className="w-full sm:px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-5 sm:gap-6 sm:mb-6">
          {categories.map((category, index) => (
            <div key={index} className="card">
              ...
              <p className="text-[15px] sm:text-base text-secondary font-roboto mb-4 leading-relaxed">{category.description}</p>
              <div>
        ...
        <div className="card backdrop-blur-sm mb-5 sm:mb-6">
          ...
          <ul className="space-y-3">
            {tips.map((tip, index) => (
              <li key={index} className="text-[15px] sm:text-base text-secondary font-roboto leading-relaxed flex items-start">
              ...
              <div className="card">
                ...
                <div className="space-y-4">
                  <div className="card-inner p-4">
                    ...
                    <p className="text-[15px] sm:text-base text-secondary">Bananas, rice, applesauce, toast, oatmeal, lean proteins</p>
                  </div>
                  <div className="card-inner p-4">
                    <h4 className="font-medium text-primary mb-2 flex items-center gap-2">
                    ...
                    <p className="text-[15px] sm:text-base text-secondary">Dairy, high-fiber foods, spicy foods, raw vegetables</p>
                  </div>
                  <div className="card-inner p-4">
                    <h4 className="font-medium text-primary mb-2 flex items-center gap-2">
                    ...
                    <p className="text-[15px] sm:text-base text-secondary">Nuts, seeds, popcorn, alcohol, caffeine, fried foods</p>
                  </div>
                </div>
              </div>
              ...
              <div className="card p-4 sm:p-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <p className="text-[15px] sm:text-base text-secondary">Pair carbs with protein to steady energy</p>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 min-w-[2rem] rounded-lg flex items-center justify-center card-inner">
                      <Soup className="w-4 h-4 text-amber-600 dark:text-white" />
                    </div>
                    <p className="text-[15px] sm:text-base text-secondary">Keep simple foods ready for flare days</p>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 min-w-[2rem] rounded-lg flex items-center justify-center card-inner">
                      <Snowflake className="w-4 h-4 text-blue-500 dark:text-white" />
                    </div>
                    <p className="text-[15px] sm:text-base text-secondary">Freeze single portions for low-energy days</p>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 min-w-[2rem] rounded-lg flex items-center justify-center card-inner">
                      <NotebookPen className="w-4 h-4 text-indigo-400 dark:text-white" />
                    </div>
                    <p className="text-[15px] sm:text-base text-secondary">Note any new foods and how your gut reacts</p>
                  </div>
                </div>
              </div>
