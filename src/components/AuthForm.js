        ...
        <div className="space-y-6">
          {error && (
           ...
           <button
             ...
             className="w-full flex justify-center items-center py-3.5 bg-white border border-gray-200 shadow-sm hover:shadow-md text-base font-semibold font-roboto text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-0 focus:ring-offset-0 transition-all duration-200"
           >
