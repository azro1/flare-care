      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="mt-8 space-y-6">
          ...
          <button
            ...
            className="w-full flex justify-center items-center py-4 px-6 bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-md text-base font-semibold font-roboto text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-4 focus:ring-blue-100 focus:border-blue-400 transition-all duration-200"
          >
        ...
        <div className="text-center">
          <p className="text-xs font-roboto text-gray-500 sm:text-sm">
