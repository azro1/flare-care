        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-center lg:justify-between gap-3">
              <div className="flex items-center justify-center gap-2">
                ...
                <p className="text-sm text-gray-600 font-roboto sm:text-base">
                  &copy; 2025 FlareCare
                </p>
              </div>
              <div className="hidden lg:flex items-center gap-2">
                <span className="text-sm text-gray-600 font-roboto sm:text-base">Supporting</span>
                <CrohnsColitisLogo size="xs" showText={false} />
                <span className="text-sm text-gray-600 font-roboto sm:text-base">Crohn's & Colitis UK</span>
              </div>
            </div>
        </div>
      </footer>
        ...
        <div className="border-t border-gray-200 pt-6">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-4">
            ...
            <div className="flex items-center gap-2 text-center">
              <span className="text-sm text-gray-600 font-roboto">Supporting</span>
