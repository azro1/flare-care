  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center space-x-2 text-sm bg-white/80 hover:bg-white text-gray-700 px-3 py-2 rounded-lg shadow-sm transition-colors duration-200 whitespace-nowrap border border-white/20"
      >
