  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center space-x-2 text-sm bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white px-3 py-2 rounded-lg shadow-sm transition-all duration-200 whitespace-nowrap"
      >
